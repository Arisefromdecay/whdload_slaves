...
;-----------------------------------------------------------------------------
	...
	OUTPUT	"HD2:util/dev/whdload/ugh/Ugh.slave"
...
patch_hunk_0
		PL_START
		PL_IFC1X 0
        PL_NOPS	$5698,3		;lives
        PL_ENDIF
		PL_IFC1X 1
		PL_NOPS	$53de,3
		;PL_NOPS $53e2,1
		PL_NOPS $5424,3
		;PL_NOPS $5428,1	 ;energy
		PL_NOPS	$548a,3
		;PL_NOPS $548e,1
		PL_NOPS	$54dc,3
		;PL_NOPS $54e0,1
